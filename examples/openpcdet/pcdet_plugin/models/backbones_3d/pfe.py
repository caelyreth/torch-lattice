...
class VoxelSetAbstractionTS(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        for k, src_name in enumerate(self.SA_layer_names):
            cur_coords = batch_dict['multi_scale_3d_features'][src_name].coords
            cur_features = batch_dict['multi_scale_3d_features'][src_name].feats.contiguous()
